...
Сірә да, көңілім тына ма?
        ...
        <div class="task-card" id="task5">
            ...
            <div class="comic-panel">
                <img src="ТЖ.jpg" alt="1-панель - Төлегеннің Жібекпен кездесуі">
                <textarea rows="2" placeholder="Репликаны осы жерге жазыңыз..."></textarea>
            </div>
            
            <div class="comic-panel">
                <img src="Төл.jpg" alt="2-панель - Жібек пен Шегенің әңгімесі">
                <textarea rows="2" placeholder="Репликаны осы жерге жазыңыз..."></textarea>
            </div>
            
            <div class="comic-panel">
                <img src="ТБ.jpg" alt="3-панель - Бекежанның сатқындығы">
                <textarea rows="2" placeholder="Репликаны осы жерге жазыңыз..."></textarea>
            </div>
            
            <div class="comic-panel">
                <img src="ЖЖ.jpg" alt="4-панель - Жібек пен жеңгесінің сырласу">
                <textarea rows="2" placeholder="Репликаны осы жерге жазыңыз..."></textarea>
            </div>
        ...
        <div class="task-card" id="task6">
            ...
            <div class="media-container">
                <img src="Кейіп.jpg" alt="Кейіпкерлер">
            </div>
